...
We build tools for authorized security research: the 0sec CLI and engine, specialized scanners, and research systems for investigating software and testing fixes.
...
- **0sec Cloud** — optional hosted models and the account surface, with an inference-first rollout still in qualification. Local and BYOK use remains account-free.
- **0cloud** — managed security testing with scoped engagements, human verification, evidence, and retesting. Separate billing.
- **0review** — CI security code review with diff-scoped findings and suggestions returned to pull requests. Separate subscription.
